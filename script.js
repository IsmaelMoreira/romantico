...
const nextBtn1 = document.querySelector('#question1 .next-btn');
...
nextBtn1.addEventListener('click', () => {
    ...
    document.getElementById('color-feedback').textContent = colorPoems[loveAnswers.color] || 'Essa cor é tão especial quanto o seu sorriso!';
    document.getElementById('feedback1').classList.remove('hidden');
});

// Feedback 1 para Pergunta 2
document.querySelector('#feedback1 .next-btn').addEventListener('click', () => {
...
const nextBtn2 = document.querySelector('#question2 .next-btn');
...
nextBtn2.addEventListener('click', () => {
    ...
    document.getElementById('height-feedback').textContent = romanticMessage;  
    document.getElementById('feedback2').classList.remove('hidden');
});

// Feedback 2 para Pergunta 3
document.querySelector('#feedback2 .next-btn').addEventListener('click', () => {
...
const nextBtn3 = document.querySelector('#question3 .next-btn');
...
nextBtn3.addEventListener('click', () => {
    ...
    document.getElementById('flower-feedback').textContent = flowerRomance[loveAnswers.flower] || 'Essa flor é tão bela quanto o seu coração!';
